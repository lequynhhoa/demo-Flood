...
var EE_URL = 'https://earthengine.googleapis.com', /** @type {string} The Earth Engine API URL. */
	DEFAULT_ZOOM = 6, /** @type {number} The default zoom level for the map. */
	MAX_ZOOM = 25, /** @type {number} The max allowed zoom level for the map. */
	DEFAULT_CENTER = { lng: 102.93, lat: 16.4 }, /** @type {Object} The default center of the map. */
	DATE_FORMAT = 'yyyy-mm-dd', /** @type {string} The default date format. */
	DataArr = [],
	all_overlays = [],
	map,
	currentShape,
...
var boot = function (eeMapId, eeToken) {
	...
	var app = new App(eeMapId, eeToken);
};
...
**/
var polygonSelectionMethod = function () {
...
var GetDates = function () {
	// Slider 1 is start and slider 2 is stop

	return [$('#slider1').val(), $('#slider2').val()];
};
